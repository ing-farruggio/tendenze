            ...
            <div className="product-layout">
                ...
                <div className="product-gallery">
                    <div style={{ background: "#e8ddd0", aspectRatio: "3/4", overflow: "hidden", position: "relative" }}>
                        ...
                        {hasMultiple && (
                            <>
                                <button onClick={prevImage} className="gallery-arrow" style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", background: "rgba(250,248,245,0.9)", border: "1px solid rgba(184,154,106,0.3)", width: 40, height: 40, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, color: "#2a2520", backdropFilter: "blur(4px)" }}>
                                    &#8249;
                                </button>
                                <button onClick={nextImage} className="gallery-arrow" style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", background: "rgba(250,248,245,0.9)", border: "1px solid rgba(184,154,106,0.3)", width: 40, height: 40, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, color: "#2a2520", backdropFilter: "blur(4px)" }}>
                                    &#8250;
                                </button>
                            </>
                        )}
                        ...
                        {hasMultiple && (
                            <div className="gallery-dots" style={{ position: "absolute", bottom: 12, left: "50%", transform: "translateX(-50%)", display: "flex", gap: 6 }}>
                                {product.images.map((_, i) => (
                                    <div key={i} onClick={() => setActiveImage(i)} style={{ width: i === activeImage ? 20 : 6, height: 6, borderRadius: 3, background: i === activeImage ? "#b89a6a" : "rgba(255,255,255,0.7)", transition: "all 0.3s ease", cursor: "pointer" }} />
                                ))}
                            </div>
                        )}
                    </div>
